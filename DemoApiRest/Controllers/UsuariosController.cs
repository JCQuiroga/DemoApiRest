...
namespace DemoApiRest.Controllers
{
    ...
    */
    ...
    {
        private RedContactosEntities db = new RedContactosEntities();
        ...
        {
            return db.Usuario.Where(m => m.id == key).SelectMany(m => m.Usuario1);
        }
        ...
        {
            return db.Usuario.Where(m => m.id == key).SelectMany(m => m.Usuario2);
        }
